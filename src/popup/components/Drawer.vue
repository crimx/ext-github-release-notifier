<template>
  <div>
    <transition name="slide">
      <nav class="drawer" v-if="show" v-once>
        ...
        <ul class="filter-list">
          ...
          <li>
            <a class="filter-item drawer-item" href="https://ko-fi.com/crimxcoffee" target="_blank" rel="noopener">
    ...
    <transition name="fade">
      <div class="drawer-mask" v-if="show" v-once @click="closeDrawer"></div>
    </transition>
  </div>
</template>
